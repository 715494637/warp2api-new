...
from ..config.settings import WARP_URL as CONFIG_WARP_URL, get_warp_client_headers, get_httpx_client_kwargs
...
async def send_protobuf_to_warp_api(
    ...
    try:
        ...
        async with httpx.AsyncClient(**get_httpx_client_kwargs(timeout=httpx.Timeout(60.0), verify=verify_opt, trust_env=True)) as client:

...
from ..config.settings import CLIENT_VERSION, OS_CATEGORY, OS_NAME, OS_VERSION, get_warp_client_headers, get_httpx_client_kwargs
...
async def query_graphql(operation_name: str, query: str, variables: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        async with httpx.AsyncClient(**get_httpx_client_kwargs(timeout=httpx.Timeout(30.0), verify=verify_opt, trust_env=True)) as client:
